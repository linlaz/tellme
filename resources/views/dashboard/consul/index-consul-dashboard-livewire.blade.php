...
<div>
    ...
    <div class="">
        <div class="row justify-content-center">
            <div class="col-md-4 @if (isset($sender)) d-md-none d-lg-block d-sm-none d-md-block d-none d-sm-block @endif">
                <div class="card">
            ...
            <div class="col-md-8  @if (is_null($sender))  d-md-none d-lg-block d-sm-none d-md-block d-none d-sm-block @endif ">
                <div class="card">
                    <div class="card-header">
                        @if (isset($sender))
                        ...
                        <div class="card-footer">
                            <form wire:submit.prevent="SendMessage">
                                <div class="row">
                                    <div class="col-md-8">
                                        {{-- <div class=""
                                            wire:model.debounce.350ms="message" wire:ignore.self>
                                            <input id="message" type="hidden" class="form-control mb-3 input shadow-none w-100 d-inline-block" name="message">
