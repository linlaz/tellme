        ...
        <article class="card my-3 border-top fs-5" @if ($loop->last) id="last_record" @endif style="font-family: 'Arvo', serif ;">
            <div class="card-body">
                ...
                <div class="position-relative">
                    <div class="title-blog mb-2" style="font-family: 'Rubik', sans-serif;">
                        <h4>{{ $item->title }}</h4>
                    </div>
                    ...
                    <div class="mb-3">
                        @isset($item->text)
                            {!! Str::limit(html_entity_decode(strip_tags($item->text)), 100, '...') !!}<a href="/blog/read/{{ $item->slug }}">[read complete]</a>
                        @endisset
